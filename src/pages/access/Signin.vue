      ...
      <q-card class="my-card fit q-mr-md">
        <q-parallax :height="200">
          <template v-slot:media>
            <video width="720" height="440" poster="statics/img/login-header.jpg" autoplay loop muted>
              <source type="video/mp4" src="statics/video/login-header.mp4">
            </video>
          </template>
          <q-card-actions vertical>
            <h3 class="text-white" style="font-family:customfont; height:20px">Educa.</h3>
                  ...
                  <div class="justify-center items-center q-pl-lg q-pr-lg q-pb-md">
                    ...
                    >
                      ...
                      <q-card-actions class="justify-end">
                        <div>
                          <q-btn type="reset"  outline rounded label="Reset Data" style="width:155px" class="items-center" unelevated color="blue-10" />
                          <q-btn type="submit" :to="{ name: 'dashboard' }" rounded outline class="q-ml-sm items-center" style="width:155px" color="green" label="Sign in now" unelevated align="right" />
                        </div>
                      </q-card-actions>
...
<style>
.bg-images{
  background-image: url("src/statics/login-bg.jpg");
